...
from pysubsurface.utils.units import kg_m3_to_g_cm3, g_cm3_to_kg_m3
from pysubsurface.proc.rockphysics.elastic import _compute_vp, Elastic
from pysubsurface.proc.rockphysics.bounds import _percent_check, voigt_bound, \
    reuss_bound
...
class Fluid(Elastic):
    ...
    :obj:`pysubsurface.proc.rockphysics.fluid.Oil` or :obj:`pysubsurface.proc.rockphysics.fluid.Brine` or
    :obj:`pysubsurface.proc.rockphysics.fluid.Gas` objects and their fractions
    and combines them.

    Parameters
    ----------
    fluids : :obj:`dict`
        Set of tuples of Fluids in :obj:`pysubsurface.proc.rockphysics.fluid.Oil`
        or :obj:`pysubsurface.proc.rockphysics.fluid.Brine` or
        :obj:`pysubsurface.proc.rockphysics.fluid.Gas` objects objects and their
        fractions
