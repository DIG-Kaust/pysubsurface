...
def _prepare(func):
    ...
    ----------
    func : :obj:`def`
        Any of the methods used :func:`pysubsurface.proc.seismicmod.avo.angle_reflectivity`
...
def angle_reflectivity_multidims(vp, vs, rho, theta=0, method='zoeppritz'):
    ...
    profiles. Refer to :func:`pysubsurface.proc.seismicmod.avo.angle_reflectivity`
...
def prestack_wellmod(logs, zaxis, theta, sampling, wav, ax=None, wavcenter=None,
    ...
    kwargs_plot : :obj:`dict`, optional
        ...
        :func:`pysubsurface.visual.utils._wiggletracecomb`
    ...
    #vplog = np.interp(zaxisreglog, zaxislog, vplog)
    #vslog = np.interp(zaxisreglog, zaxislog, vslog)
    #rholog = np.interp(zaxisreglog, zaxislog, rholog)
