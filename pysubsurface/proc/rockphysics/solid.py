...
from pysubsurface.proc.rockphysics.elastic import Elastic
...
class Matrix():
    ...
    :obj:`pysubsurface.proc.rockphysics.elastic.Elastic` objects and their fractions
...
class Rock(Elastic):
    ...
    rho : :obj:`float` or :obj:`numpy.ndarray`
        Density in kg/m3
    matrix : :obj:`pysubsurface.proc.rockphysics.elastic.Matrix`
        Matrix
    fluid : :obj:`pysubsurface.proc.rockphysics.fluid.Fluid`
        Fluid definition
