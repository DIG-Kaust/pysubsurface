...
from pysubsurface.proc.rockphysics.elastic import _compute_vp, _compute_vs
from pysubsurface.proc.rockphysics.solid import Rock
...
class Gassmann:
    ...
    Parameters
    ----------
    medium0 : :obj:`pysubsurface.proc.rockphysics.solid.Rock`
        Initial saturated medium
    fluid1 : :obj:`pysubsurface.proc.rockphysics.fluid.Fluid`
        Final fluid
    ...
    def _compute(self, ):
        ...
        # another way of computing ksat1 from Quantitative Seismic Interpretation book
        #kright = self.fluid1.k / (self.medium0.poro * (kmatrix - self.fluid1.k)) + \
        #         self.medium0.k / (kmatrix - self.medium0.k) - \
        #         self.medium0.fluid.k / (self.medium0.poro * (kmatrix - self.medium0.fluid.k))
        #ksat1 = kmatrix * kright / (1. + kright)
