...
def zerooffset_wellmod(logs, zaxis, sampling, wav, ax=None, zaxisshift=0.0,
    ...
    Parameters
    ----------
    logs : :obj:`pysubsurface.objects.Logs.Logs`
        Logs object
    zaxis : :obj:`str`
    ...
    if plotflag:
        ...
        #    axs[0].plot(ailog, zaxisreglog, 'k', lw=2)
        #    axs[0].set_ylabel(zaxis)
        #    axs[0].set_title('AI')
        #    axs[1].plot(reflectivity, rzaxisreglog, 'k')
        #    axs[1].set_ylabel(zaxis)
        #    axs[1].set_title('Reflectivity')
        #    axs[2] = _wiggletrace(axs[2], zaxisreglog, trace)
        ...
        #    _add_officiallabel(fig)
        #else:
        #   fig = None
        #    ax = _wiggletrace(ax, zaxisreglog, trace)
...
def zerooffset_geomod(geomodel, intervalnames, aveprops,
    ...
    Parameters
    ----------
    geomod : :obj:`pysubsurface.objects.Seismic` or :obj:`pysubsurface.objects.SeismicIrregular`
        Geomodel created via :func:`pysubsurface.proc.geomod.geomod.create_geomodel`
    ...
    aveprops : :obj:`dict`
        ...
        :func:`pysubsurface.objects.Project.create_averageprops_intervals`
    ...
    kwargs_view : :obj:`dict`, optional
         Additional parameters to pass to :func:`pysubsurface.objects.Seismic.view`

    Returns
    -------
    seismod : :obj:`pysubsurface.objects.Seismic` or :obj:`pysubsurface.objects.SeismicIrregular`
        Zero-offset seismic object
    aigeomod : :obj:`pysubsurface.objects.Seismic` or :obj:`pysubsurface.objects.SeismicIrregular`
