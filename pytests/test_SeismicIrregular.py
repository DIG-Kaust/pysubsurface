...
def test_seismic_dims(par):
    ...
    """
    # load seismic
    d = SeismicIrregular(segyfile, loadcube=True, iline=21, xline=25, scale=1)
...
def test_seismic_subcube(par):
    ...
    """
    # load seismic
    d = SeismicIrregular(segyfile, loadcube=False, iline=21, xline=25, scale=1)
...
def test_extract_subcube():
    ...
    """
    # load seismic
    seismic = SeismicIrregular(segyfile, loadcube=False,
                               iline=21, xline=25, scale=1)
...
def test_extract_attribute_map_fixedtime():
    ...
    # load seismic
    seismic = SeismicIrregular(segyfile, loadcube=True, iline=21,
                               xline=25, scale=1)
...
def test_view():
    ...
    """
    # load seismic
    seismic = SeismicIrregular(segyfile, loadcube=False, iline=21,
                               xline=25, scale=1)
